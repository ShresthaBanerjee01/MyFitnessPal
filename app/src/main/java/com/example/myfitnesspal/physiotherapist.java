...
public class physiotherapist extends AppCompatActivity {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!placeName.isEmpty()) {
                    ...
                    Toast.makeText(physiotherapist.this, "Please enter your pincode", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private void readExcelFileFromAssets() {
        try {
            InputStream inputStream = getAssets().open("physiotherapists.xls");
    ...
    private void filterHotels(String placeName) {
        ...
        if (filteredHotels.isEmpty()) {
            Toast.makeText(physiotherapist.this, "Pincode not avalaible", Toast.LENGTH_SHORT).show();
        }
