...
public class psychiatrist extends AppCompatActivity {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!placeName.isEmpty()) {
                    ...
                    Toast.makeText(psychiatrist.this, "Please enter your pincode", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private void readExcelFileFromAssets() {
        try {
            InputStream inputStream = getAssets().open("psychiatrists.xls");
    ...
    private void filterHotels(String placeName) {
        ...
        if (filteredHotels.isEmpty()) {
            Toast.makeText(psychiatrist.this, "Pincode not avalaible", Toast.LENGTH_SHORT).show();
        }
